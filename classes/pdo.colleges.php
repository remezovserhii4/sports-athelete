<?php
	...
	Class Colleges extends Database{
		...
		//get the old comment from db by user id	
		public function getusercolleges($userid){

            $this->query("SELECT college.id, college.title, college.image, usercollege.sport, usercollege.scholar, usercollege.interest "
            			." FROM usercollege,college WHERE usercollege.collegeid = college.id AND userid=:userid ORDER BY usercollege.id");
